  ...
  return (
    <>
      <div className="ModalView">
        ...
        <p>Example usage: "Yerrrrr!"</p>
      </div>
      <div>
        <p>
          Use a 'Yerrr' to invite local folks for a bite! Select between a group
          or one-on-one meetup, start a chat before you meet, and view others'
